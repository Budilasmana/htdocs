package com.fahriza.hellotoasts;
...
//    public static final int NOTIFIKASI_ID = 1;
    ...
    public void run_toast(View view) {
        Toast isi = Toast.makeText(this, "Jumlah Score Renang = "+isiCount+"", Toast.LENGTH_LONG);
        isi.show();
    }
    ...
    public void run_count(View view) {
        ...
        if (isiCount==data) {
            ...
            Toast isi = Toast.makeText(this, "Score yang masuk = " + data + "", Toast.LENGTH_LONG);
            isi.show();
            data += a;
        }
...
//batas----------------------------------------------------------------------------------------------
    ...
    public void run_toasts(View view) {
        Toast isii = Toast.makeText(this, "Jumlah Score Sepak bola = "+isiCounts+"", Toast.LENGTH_LONG);
        isii.show();
    }
    ...
    public void run_resets(View view) {
        isiCounts = 0;
        datas = 10;
        Toast isii = Toast.makeText(this, "Score berhasil Tereset", Toast.LENGTH_LONG);
        isii.show();
        if (tampilCounts != null) {
            tampilCounts.setText(Integer.toString(isiCounts));
        }
    }
    ...
    public void run_counts(View view) {
        ...
        if (isiCounts==datas) {
            ...
            Toast isi = Toast.makeText(this, "Score yang masuk = " + datas + "", Toast.LENGTH_LONG);
            isi.show();
            datas += a;
        }
